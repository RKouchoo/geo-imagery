...
def  getLatestDataFromS3(queryUrl, 
    ...
    # if its been manually set, fuck the check
    notValid = saTime.getIsGenerated()
    retryCount = 0
    ...
    # also check here if its autogenerated or custom
    # we do the check only if auto - PEBCAK
    if saTime.getIsGenerated():
